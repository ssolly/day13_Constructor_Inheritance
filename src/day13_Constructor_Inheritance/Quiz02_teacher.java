...
class Loginn extends Win7Quiz{
    private String userId=null,userPw=null;//User
    public Loginn(String c,String m,String cPath,String mPath){
...
public static void main(String[] args){
    ...
    Loginn lo = new Loginn("계산기","메모장","calc.exe","notepad.exe"); 
    boolean flag=true;
    ...
    while(flag){
        ...
        switch(num){
            ...
            case 2: 
            	...
            	break;
            case 3:
            	flag=lo.out();System.out.println("종료 합니다");
        }
    }
}
